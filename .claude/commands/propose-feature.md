...
Run one full round of the [autonomous feature workflow](../../docs/AGENT-WORKFLOW.md).

1. **Read first, in order:** `docs/STRATEGY.md` (north star), `docs/PREFERENCES.md`
...
4. **Open a PR** off the latest `main` on a `claude/<summary>` branch, ready for
   review, using the PR body template in `docs/AGENT-WORKFLOW.md`. Do not merge it
...
`docs/AGENT-WORKFLOW.md`: classify the rejection as *direction* vs *execution*,
record the generalised lesson in `docs/PREFERENCES.md`, log it, commit the learning,
